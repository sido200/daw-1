...
$sql = "SELECT ville.*, pays.nompays, continent.nomcon, necessaire.hotel, necessaire.gare, necessaire.aeroport
        FROM ville
        ...
        <div class="col s6 md3">
            <div class="card z-depth-0">
                <div class="card-content center">
                    ...
                    <ul>
                        <?php foreach(explode(',', $voyage['hotel']) as $ing): ?>
                        <li> <?php echo htmlspecialchars($ing) ?></li>
                        <?php endforeach; ?>
                    </ul>
                    <ul>
                        <?php foreach(explode(',', $voyage['gare']) as $ing): ?>
                        <li> <?php echo htmlspecialchars($ing) ?></li>
                        <?php endforeach; ?>
                    </ul>
                    <ul>
                        <?php foreach(explode(',', $voyage['aeroport']) as $ing): ?>
                        <li> <?php echo htmlspecialchars($ing) ?></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
